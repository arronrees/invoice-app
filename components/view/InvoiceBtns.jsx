...
export default function InvoiceBtns({ className }) {
  return (
    <div className={className}>
      <Link href='/edit'>
        <a className='inline-block text-center font-bold bg-x-light-grey text-light-blue px-8 py-6 rounded-full transition duration-300 hover:bg-light-grey focus:ring-2 ring-bg-light-grey ring-offset-2 focus:outline-none mb-4 lg:text-lg sm:mb-0 sm:mr-4'>
          Edit
        </a>
      </Link>
